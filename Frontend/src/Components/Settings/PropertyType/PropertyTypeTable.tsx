...
import PropertyTypeRowActions from './PropertyTypeRowActions';
...
export const PropertyTypeTable = () => {
    const [tableData, setTableData] = useState<PropertyTypeData[]>([]);
    ...
    const fetching = async () => {
        ...
        setError(null);
        try {
            const response = await apiCall<{ data: PropertyTypeData[] }>({
            ...
            setSnackbar({
                open: true,
                message: "An error occurred while fetching Property Types data",
                severity: "error",
            });
        } finally {
            setLoading(false);
                ...
                <table className="min-w-full bg-white">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="px-4 py-2 text-left border font-medium font-lexend text-gray-700 text-[10px]">Property Type Name</th>
