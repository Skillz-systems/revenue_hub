    ...
    >
      ...
      <div className="flex items-center justify-between w-full gap-2">
        <div className="flex flex-col gap-y-2 w-[50%] align-center justify-center">
          <p className="font-medium text-color-black text-left font-lexend text-[11px] leading-[13px] printPaddingBottom pb-4">
            BILL INFORMATION
          </p>
        ...
        <div className="flex flex-col gap-0 border rounded border-custom-color-100 w-[50%]">
          {demandInvoiceData.billDetailsData.map((item: any, index: any) => (
            ...
            >
              <p className="font-medium text-black text-left w-[130px] printPaddingBottom2 pb-2">
                {item.label} :
              </p>
              <p className="flex items-center justify-center  text-primary-color printPaddingBottom2 pb-2 z-50 font-black">
                <span className="mr-1 text-xs text-color-bright-green">
                  ₦
                </span>
                <span className="z-50 font-black">{`${formatNumberWithCommas(item.value)}`}</span>
              </p>
            </div>
          ))}
        </div>
      ...
      <div className="flex flex-col w-full space-y-1 border rounded border-custom-color-one font-medium">
        <p className="text-[11px] p-1 font-lexend leading-[12.5px] text-black border-b border-custom-color-one pb-2 printPaddingBottom pb-4">
        ...
        <div className="flex p-1 printPaddingBottom font-medium pb-4">
      ...
      {/* 6TH SECTION */}
      <p className="font-bold text-[9px] leading-[11px] text-black text-center font-red-hat">
