            ...
            <div className='flex justify-between'>
                <div className="flex space-x-4">
                    ...
                    <div className="flex flex-col justify-center ">
                        ...
                        <h1 className='text-stone-950 font-bold font-lexend font-[600] text[14px] leading-[16px]'>{subtitle}</h1>
                    </div>
                </div>
                <div>
                    {datepicker && (<div className='flex space-between h-fit w-fit items-center border rounded-md border border-[#CCD0DC] p-1 space-x-1 bg-[#F6F8FA]'>
                        <div className='font-lexend font-medium text-gray-400 text-base tracking-wide'>{dateContent}</div>
