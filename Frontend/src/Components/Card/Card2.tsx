...
const Card2: React.FC<Card2Props> = ({ cardData }) => {
  return (
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-start space-x-3">
              <span
                ...
                ${[1].includes(card.id) ? "bg-custom-blue-200 text-primary-color" : ""
                  }
                ${[2, 3].includes(card.id) ? "bg-color-light-yellow text-color-bright-orange" : ""
                  }  
              `}
              >
                {card.icon}
